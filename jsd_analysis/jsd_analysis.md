...
![](jsd_analysis_files/figure-gfm/bdproto_vs_phoible_plots-1.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/bdproto_vs_phoible_plots-4.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/basic_count_data-4.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/basic_count_data-9.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/loo-2.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/loo-3.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/loo-4.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/loo-5.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/loo-6.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/single_term_models-1.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/plotting_by_macroarea_and_family-2.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/plotting_by_macroarea_and_family-3.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/modeling_within_africa-1.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/remove_labiodentals-2.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/resampling-1.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/resampling-2.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/resampling-3.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/resampling-4.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/resampling-5.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/resampling-6.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/resampling-7.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/resampling-8.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/modeling_noOverlap-1.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/modeling_noOverlap-2.png)<!-- -->
...
```
    ...
    ## PtoQ              1 32.556  32.556 12003.0 < 2.2e-16 ***
    ## Macroarea         5 99.265  19.853  7319.5 < 2.2e-16 ***
    ## PtoQ:Macroarea    5  2.630   0.526   193.9 < 2.2e-16 ***
    ## Residuals      5988 16.241   0.003                      
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
![](jsd_analysis_files/figure-gfm/modeling_sim_to_segbo-1.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/modeling_sim_to_segbo-2.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/modeling_sim_to_segbo-3.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/modeling_sim_to_segbo-4.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/modeling_sim_to_segbo-5.png)<!-- -->
...
![](jsd_analysis_files/figure-gfm/modeling_sim_to_segbo-6.png)<!-- -->
